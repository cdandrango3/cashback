                        ...
                        ?>
                            <tr id="row<?= $i?>">
                                <td style="text-align:center!important;">
                                    <a data-toggle="tooltip" data-placement="top" rel="tooltip" data-original-title="Eliminar" class="btn btn-danger btn-xs" href="javascript:void(0);" onclick="deldetail(this, caltotal); return false;"><i class="fas fa-trash "></i></a>
                                </td>
                                <td>
