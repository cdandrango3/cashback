		...
		<div class="panel-toolbar-wrapper pl10 pr10 pt5 pb5">
			<div class="card-header text-right">
				<div class="btn-group">
					...
					<a style="color:white; important!" data-toggle="tooltip" data-placement="top" title="Ver Transacción" rel="tooltip" class="btn btn-primary btn" href="">
						<span class="fas fa-search"></span>
					</a>
					<a style="color:white; important!" target="_blank" data-toggle="tooltip" data-placement="top" title="PDF" rel="tooltip" class="btn btn-default btn text-danger" href="<?= Url::to(['accountingseats/viewpdf', 'id' => $model->id]) ?>">
